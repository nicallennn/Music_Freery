...
const majorScale = {
  ...
  const melMinorScale = {
    ...
    result_2: "The notes is the descending scale of C melodic minor are the same as the notes in the C natural minor scale",
...
export {majorScale, natMinorScale, harMinorScale, melMinorScale};
